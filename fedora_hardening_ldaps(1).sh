...
dnf5 install -y sssd openldap-clients authselect oddjob-mkhomedir
...
dnf5 install -y httpd mod_ssl

log "Installing PHP for Roundcube"
dnf5 install -y php php-mysqlnd php-mbstring php-intl php-xml php-json php-ldap
...
if dnf5 list roundcubemail &>/dev/null; then
  dnf5 install -y roundcubemail
